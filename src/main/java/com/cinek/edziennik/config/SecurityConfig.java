...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
	            ...
	            .antMatchers("/myProfile/**").access("hasRole('ROLE_STUDENT') OR hasRole('ROLE_TEACHER')")
	            .antMatchers("/conversation/**").access("hasRole('ROLE_STUDENT') OR hasRole('ROLE_TEACHER')")
	            .antMatchers("/doUpload/**").access("hasRole('ROLE_STUDENT') OR hasRole('ROLE_TEACHER')")
	            .and()
		        .formLogin()
